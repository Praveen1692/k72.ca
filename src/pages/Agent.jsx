...
function Agent() {
  ...
  console.log("Image Div ref", imageDivRef.current);
  ...
  return (
    <div>
      <div className="section1">
        <div
          ref={imageDivRef}
          className="h-[20vw] overflow-hidden  rounded-3xl -z-20    w-[15vw]  absolute top-30 left-[30vw]"
        >
          <img
            className="h-full w-full object-cover"
            src="https://k72.ca/images/teamMembers/MEGGIE_640X980_2.jpg?w=640&h=960&s=7d78cdb1fad347408e05a311cc4018ef"
            alt="img"
          />
        </div>

        <div className="font-[font2]">
          <div className="mt-[55vh] z-auto">
